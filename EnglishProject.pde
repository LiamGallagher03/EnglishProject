...
public void draw() {
  ...
  case 4:
    ...
    break;
  case 5:
    textBoxes[0] = new TBox(200, 100, 1520, 200, "General Values", 50, #0000FF, #FFFFFF, 20, #FF0000);
    textBoxes[1] = new TBox(200, 400, 1520, 800, longStrings[4], 40, #0000FF, #FFFFFF, 20, #FF0000);
    for (TBox box : textBoxes) box.draw();
    checkClick = false;
    break;
  }
...
public void setStrings() {
  ...
  longStrings[3] = "Happiness, like every other emotion, can be good and bad to have. Biologically, the feeling of happiness is the product of chemicals relasing in your brain when you do something that the body deems as satisfying. This may seem like a very dull view of the emotional state of the human mind, but this very idea is true for all emotions. Emotions do not define the soul, the soul defines itself. Being happy tends to be good, but being able to show your emotions in a healthy way is always better.";
  longStrings[4] = "";
}
